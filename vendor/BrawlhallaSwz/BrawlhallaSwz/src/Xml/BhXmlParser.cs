...
public static class BhXmlParser
{
    ...
    private static bool Exists(this XNode e, string attribute)
    {
        ...
        return ee.Attribute(attribute) is not null;
    }
    ...
    // added as a util
    public static XElement? ParseElement(string str, bool strict = false) => Parse(str, strict).Root;
